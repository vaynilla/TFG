...
\textbf{GRÁFICA + BREVE EXPLICACIÓN}
...
\textbf{COSAS PARA HACER:}

- meter el displaystyle en las integrales para que se vean mas grandes
- poner el ejemplo del sistema en la equivalencia, resolverlo mediante aprox. sucesivas, maxima y compararlas con graficas, además cambiar el número de iteraciones para ver la diferencia
- En el modelo, mirar el TFM tranquilamente y añadir un ejemplo con 4-5 habitaciones o los dos mejor, y resolverlo al igual que en la equivalencia?¿
- Cambiar las graficas de la aplicacion y comentarlas. 
