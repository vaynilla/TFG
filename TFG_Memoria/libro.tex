...
\newcommand{\miTitulo}{Métodos para la resolución de ecuaciones integrales y su integración en un sistema para la simulación de la distribución de temperatura en edificios mediante el uso de servicios web\xspace}
...
\input{capitulos/existencia}

\input{capitulos/capitulo02}

\input{capitulos/sistemas}

\input{capitulos/ecdiferenciales}
...
\input{apendices/especificacionopenapi}
